...
INSERT INTO `roles` VALUES (1,'ADMIN','Quß║ún trß╗ï hß╗ç thß╗æng','ACTIVE',0),(2,'MANAGER','Ph├¬ duyß╗çt v├á gi├ím s├ít hß╗ç thß╗æng','ACTIVE',0),(3,'WAREHOUSE_MANAGER','Quß║ún l├¢ kho vß║¡t l├¢','ACTIVE',0),(4,'STAFF','Nh├ón vi├¬n kß╗╣ thuß║¡t/vß║¡n h├ánh kho','ACTIVE',0),(5,'SELLER','Nh├ón vi├¬n kinh doanh','ACTIVE',0);
...
CREATE TABLE `users` (
  ...
  `can_import_inventory` tinyint DEFAULT '0',
  `can_export_inventory` tinyint DEFAULT '0',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`user_id`),
...
INSERT INTO `users` VALUES (1,1,'System Admin','admin@gms.vn','admin','6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b','0900000001','Ha Noi',NULL,'ACTIVE','2026-06-30 21:27:55.000000','2026-06-30 21:27:55.000000',NULL,NULL,'INTERNAL',NULL,0,0,0,0),(2,2,'Nguyen Van Manager','manager@gms.vn','manager','6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b','0900000002','Ha Noi',NULL,'ACTIVE','2026-06-30 21:27:55.000000','2026-06-30 21:27:55.000000',NULL,NULL,'INTERNAL',NULL,0,0,0,0),(3,3,'Tran Thi Warehouse','warehousemanager@gms.vn','warehousemanager','6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b','0900000003','Ha Noi',NULL,'ACTIVE','2026-06-30 21:27:55.000000','2026-06-30 21:27:55.000000',NULL,NULL,'INTERNAL',NULL,0,0,0,0);
...
-- Dump completed on 2026-06-30 21:30:10
