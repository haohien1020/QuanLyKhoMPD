                    ...
                    List<String> allRoles = (List<String>) request.getAttribute("allRoles");
                            ...
                            <body id="page-top">
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        <div
                                                            ...
                                                            <h1 class="h3 mb-0 text-gray-800">
                                                                <i class="fas fa-users text-primary"></i> Quản lý người
                                                                dùng
                                                            </h1>
                                                            ...
                                                            <% } %>
                                                                ...
                                                                <% if ("created".equals(successParam)) { %>
                                                                    <div
                                                                        ...
                                                                        <i class="fas fa-check-circle"></i> Tạo tài
                                                                        khoản thành công.
                                                                        <button type="button" class="close"
                                                                            data-dismiss="alert"><span>&times;</span></button>
                                                                    </div>
                                                                    <% } else if ("banned".equals(successParam)) { %>
                                                                        <div
                                                                            class="alert alert-success alert-dismissible fade show">
                                                                            <i class="fas fa-check-circle"></i> Đã khóa
                                                                        ...
                                                                        <% } else if ("unbanned".equals(successParam)) {
                                                                            ...
                                                                            <div
                                                                                class="alert alert-success alert-dismissible fade show">
                                                                                <i class="fas fa-check-circle"></i> Đã
                                                                            ...
                                                                            <% } else if
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    Không thể khóa/mở khóa chính tài
                                                                                    khoản của bạn.
                                                                                    <button type="button" class="close"
                                                                                        data-dismiss="alert"><span>&times;</span></button>
                                                                                </div>
                                ...
                                <tr>
                                    <td><%= u.getUserId() %></td>
                                    <td><%= u.getUsername() %></td>
                                    <td><%= u.getFullName() != null ? u.getFullName() : " -" %>
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <%= u.getEmail()
                                                                                                                        !=null
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form id="toggleForm"
                                                    action="${pageContext.request.contextPath}/admin/user/toggle-active"
