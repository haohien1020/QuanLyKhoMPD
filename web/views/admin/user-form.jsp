    ...
    <%@ page import="java.util.List" %>
        ...
        <% String error=(String) request.getAttribute("error"); String success=(String) request.getAttribute("success");
            @SuppressWarnings("unchecked") List<String> allRoles = (List<String>) request.getAttribute("allRoles");
                ...
                String selectedRole = request.getAttribute("selectedRole") != null ? (String)
                request.getAttribute("selectedRole") : "";

                String fUsername = request.getAttribute("f_username") != null ? (String)
                request.getAttribute("f_username") : "";
                String fFullName = request.getAttribute("f_fullName") != null ? (String)
                request.getAttribute("f_fullName") : "";
                ...
                Boolean fActive = request.getAttribute("f_active") != null ? (Boolean) request.getAttribute("f_active")
                : true;
                %>
                                                        ...
                                                        <% } %>
                                                            ...
                                                            <div class="card shadow mb-4">
                                                                <div class="card-header py-3">
                                                                    <h6 class="m-0 font-weight-bold text-primary">Thông
                                                                        tin tài khoản mới</h6>
                                                                </div>
                                                                <div class="card-body">
                                                                    ...
                                                                    <form method="post"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="username">Tài khoản <span
                                                                                    class="text-danger">*</span></label>
                                                                            <input type="text" id="username"
                                                                                name="username" class="form-control"
                                                                                value="<%= fUsername %>" required
                                                                                autocomplete="off" minlength="3"
                                                                                maxlength="30">
                                                                            <small class="form-text text-muted">3–30 ký
                                                                                tự.</small>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <small class="form-text text-muted">Ít nhất
                                                                                6 ký tự, có 1 chữ hoa và 1 số.</small>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <small class="form-text text-muted">2–100 ký
                                                                                tự.</small>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-row">
                                                                            ...
                                                                            <div class="form-group col-md-6">
                                                                                ...
                                                                                <small class="form-text text-muted">Cho
                                                                                    phép `0xxxxxxxxx`, `84xxxxxxxxx`,
                                                                                    hoặc `+84xxxxxxxxx`.</small>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select id="active" name="active"
                                                                                class="form-control">
                                                                                <option value="true" <%=fActive
                                                                                    ? "selected" : "" %>>Hoạt động
                                                                                </option>
                                                                                <option value="false" <%=!fActive
                                                                                    ? "selected" : "" %>>Đã khóa
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="border rounded p-3">
                                                                                <% if (allRoles==null ||
                                                                                    ...
                                                                                    <% } else { for (String rc :
                                                                                        allRoles) { boolean
                                                                                        checked=rc.equals(selectedRole);
                                                                                        %>
                                                                                        <div
