<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="model.User" %>
        ...
        <% User u=(User) request.getAttribute("viewUser"); String error=(String) request.getAttribute("error"); User
            currentUser=(User) session.getAttribute("currentUser"); String successParam=request.getParameter("success");
            String errorParam=request.getParameter("error"); String phoneVal="" ; if (u !=null && u.getPhone() !=null) {
            ...
            <head>
                <meta charset="UTF-8">
                <title>Chi tiết người dùng | Generator Management System</title>
                                            ...
                                            <% } %>
                                                ...
                                                <% if ("updated".equals(successParam)) { %>
                                                    <div class="alert alert-success alert-dismissible fade show">
                                                        <i class="fas fa-check-circle"></i> Cập nhật thông tin thành
                                                        công.
                                                        <button type="button" class="close"
                                                            data-dismiss="alert"><span>&times;</span></button>
                                                    </div>
                                                    <% } else if ("username_empty".equals(errorParam)) { %>
                                                        <div class="alert alert-danger">Username không được để trống.
                                                        </div>
                                                        <% } else if ("username_len".equals(errorParam)) { %>
                                                            <div class="alert alert-danger">Username phải từ 3 đến 30 ký
                                                                tự.</div>
                                                            <% } else if ("fullname_empty".equals(errorParam)) { %>
                                                                <div class="alert alert-danger">Họ tên không được để
                                                                    trống.</div>
                                                                <% } else if ("fullname_len".equals(errorParam)) { %>
                                                                    <div class="alert alert-danger">Họ tên phải từ 2 đến
                                                                        100 ký tự.</div>
                                                                    <% } else if ("email_empty".equals(errorParam)) { %>
                                                                        <div class="alert alert-danger">Email không được
                                                                            để trống.</div>
                                                                        <% } else if
                                                                            ("phone_invalid".equals(errorParam)) { %>
                                                                            <div class="alert alert-danger">Số điện
                                                                                thoại không hợp lệ.</div>
                                                                            <% } else if
                                                                                ("username_taken".equals(errorParam)) {
                                                                                %>
                                                                                <div class="alert alert-danger">Username
                                                                                    đã tồn tại.</div>
                                                                                <% } else if
                                                                                    ("email_taken".equals(errorParam)) {
                                                                                    %>
                                                                                    <div class="alert alert-danger">
                                                                                        Email đã tồn tại.</div>
                                                                                    <% } else if
                                                                                        ("phone_taken".equals(errorParam))
                                                                                        { %>
                                                                                        <div class="alert alert-danger">
                                                                                            Số điện thoại đã tồn tại.
                                                                                        </div>
                                                                                        <% } else if
                                                                                            ("update_failed".equals(errorParam))
                                                                                            { %>
                                                                                            <div
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form id="toggleForm"
                                    action="${pageContext.request.contextPath}/admin/user/toggle-active" method="post"
                                    class="d-inline">
