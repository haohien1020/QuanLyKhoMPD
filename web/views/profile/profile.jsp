                                            ...
                                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <button type="submit" form="profileForm"
                                                        class="btn btn-success btn-sm d-none" id="btnSave">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="card shadow mb-4">
                                                        <div class="card-header py-3">
                                                            <h6 class="m-0 font-weight-bold text-primary">Thông tin tài
                                                                khoản</h6>
                                                        </div>
                                                        <div class="card-body">
                                                            <form id="profileForm" method="post"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="fullName"
                                                                        class="form-control js-editable"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <c:choose>
                                                                        <c:when
                                                                            test="${profileUser != null && profileUser.active}">
                                                                            <span class="badge badge-success">Hoạt
                                                                                động</span>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <span class="badge badge-secondary">Ngừng
                                                                                hoạt động</span>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <c:choose>
                                                                        <c:when test="${not empty profileUser.roles}">
                                                                            <c:forEach var="r"
                                                                                items="${profileUser.roles}"
                                                                                varStatus="st">
                                                                                <span
                                                                                    class="badge badge-info">${r}</span>
