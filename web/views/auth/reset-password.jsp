                                                ...
                                                <% if (errorMessage !=null) { %>
                                                    ...
                                                    <% } %>
                                                        ...
                                                        <% Boolean canReset=(Boolean) request.getAttribute("canReset");
                                                            String token=(String) request.getAttribute("token"); boolean
                                                            showResetForm=Boolean.TRUE.equals(canReset) && token !=null;
                                                            %>
                                                            <% if (showResetForm) { %>
                                                                <form method="post"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="password-requirements mt-2">
                                                                            <div class="requirement" id="req-length">
                                                                                <i class="fas fa-circle"></i> Ít nhất 6
                                                                                ký tự
                                                                            </div>
                                                                            <div class="requirement" id="req-uppercase">
                                                                                <i class="fas fa-circle"></i> Ít nhất 1
                                                                                chữ hoa
                                                                            </div>
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-success btn-reset btn-block"
                                                                        id="submitBtn">
                                                                        <i class="fas fa-check-circle"></i> Đặt Lại Mật
                                                                        Khẩu
                                                                    </button>
                                                                </form>
                                                                <% } %>
