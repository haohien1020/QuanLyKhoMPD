                ...
                if (res && res.length > 0) {
                    ...
                    res.forEach(function(item) {
                        ...
                        html += '<td class="text-center align-middle">'
                             +  '<img class="modal-barcode-render" data-serial="' + item.serialNumber + '" style="height: auto; max-width: 240px; width: auto; display: block; margin: 0 auto; background: #fff; padding: 2px 6px; border: 1px solid #cbd5e1; border-radius: 4px;" alt="Barcode" />'
